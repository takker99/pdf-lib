...
> Changes are only merged into `master` when they are 100% ready to be released.
...
I review and respond to discussions when I the have time and energy to do so,
