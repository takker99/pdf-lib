...
If it's possible to build your PR without introducing new dependencies, then
...
`pdf-lib` is written in TypeScript. This means that the project's source code is
